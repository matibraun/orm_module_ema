# Generated by Django 3.1.3 on 2021-02-01 16:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telAlternativo', models.CharField(blank=True, max_length=300, null=True)),
                ...
                ('centroDeAtencion', models.CharField(max_length=300)),
                ...
                ('coberturaMedica', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.coberturamedicamodel')),
                ('diagnostico', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.diagnosticomodel')),
                ('estadoCivil', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.estadocivilmodel')),
                ('formaClinica', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.formaclinicamodel')),
                ('genero', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.generomodel')),
                ('gruposDeApoyo', models.ManyToManyField(through='crm.GrupoDeApoyoPacienteModel', to='crm.GrupoDeApoyoModel')),
            ],
        ),
        migrations.CreateModel(
            name='ProvinciaModel',
        ...
        migrations.CreateModel(
            name='SintomaPacienteModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.pacientemodel')),
                ('sintoma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.sintomamodel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='TerapiaRehabilitacionPacienteModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.pacientemodel')),
                ('terapiaRehabilitacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.terapiarehabilitacionmodel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='terapiarehabilitacionmodel',
            name='pacientes',
            field=models.ManyToManyField(through='crm.TerapiaRehabilitacionPacienteModel', to='crm.PacienteModel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='sintomamodel',
            name='pacientes',
            field=models.ManyToManyField(through='crm.SintomaPacienteModel', to='crm.PacienteModel'),
        ),
        migrations.AddField(
            model_name='pacientemodel',
            name='sintomas',
            field=models.ManyToManyField(through='crm.SintomaPacienteModel', to='crm.SintomaModel'),
        ),
        migrations.AddField(
            model_name='pacientemodel',
            name='situacionHabitacional',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.situacionhabitacionalmodel'),
        ),
        migrations.AddField(
            model_name='pacientemodel',
            name='situacionLaboral',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.situacionlaboralmodel'),
        ),
        migrations.AddField(
            model_name='pacientemodel',
            name='talleres',
        ...
        migrations.AddField(
            model_name='pacientemodel',
            name='teEnterasteDeEmaPor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='crm.teenterastepormodel'),
        ),
        migrations.AddField(
            model_name='pacientemodel',
            name='terapiasRehabilitacion',
            field=models.ManyToManyField(through='crm.TerapiaRehabilitacionPacienteModel', to='crm.TerapiaRehabilitacionModel'),
        ),
        migrations.AddField(
            model_name='pacientemodel',
