...
class PacienteModel(models.Model):
    ...
    usuarioQueRealizoAlta = models.IntegerField(blank=False, null=False)
...
#     paciente = models.ForeignKey(PacienteModel, on_delete=models.CASCADE)
#     usuario = models.ForeignKey(UsuarioModel, on_delete=models.RESTRICT)
...
class ReunionModel(models.Model):
    ...
    areaAlQueSeDerivo = models.ForeignKey(AreaModel, on_delete=models.RESTRICT, blank=True, null=True)
